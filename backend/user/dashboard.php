          ...
          <div class="row">
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Book your appointment<i
                      class="mdi mdi-account-edit mdi-24px float-end"></i></h4>
                  <h2 class="mb-3">Your appointment</h2>
                  <h6 class="card-text mb-3">Click below to book your appointment for your pet</h6>
                  <a href="BookAppointment.php" class="btn btn-light btn-sm">Book Now</a>
                </div>
              </div>
            </div>
          </div>
